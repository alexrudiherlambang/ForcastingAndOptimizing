<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url("assets/images/jasentra.jpg")?>" type="image/x-icon">
    <link rel="icon" href="<?php echo base_url("assets/images/jasentra.jpg")?>" type="image/x-icon">
    <title>Forcasting And optimizing</title>
    <!-- Google font-->
